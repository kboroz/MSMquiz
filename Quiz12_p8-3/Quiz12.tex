...
\frame{
\color{brown}
Quiz 12: Proof Theorem 28 and 29. \\
\begin{theorem}[Theorem 29]
Let $X,X_{1},X_{2},..$ be i.i.d. and $\bar{X_{n}}=\frac{1}{n}\overset{n}{\underset{i=1}{\sum}}X_{i}$.\\
Then if $E|X|<\infty$ it holds $\bar{X_{n}}\stackrel{2nd}{\rightarrow}\mu=E[X]$.
\end{theorem}
\linebreak
\color{black}
\\
